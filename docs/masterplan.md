# Masterplan — Build Iteration V2

**Build iteration:** V2 · **Release version:** v0.1.0 (pre-alpha) · **Status:** approved, not started · **Last updated:** 2026-07-25

This is the governing sequencing document for V2. It decides what gets built, in what
...
| 13 | **Linux is out of scope for V2 entirely** | A third native enforcement implementation, and Wayland restricts input grabbing further. Not deferred — excluded. |
